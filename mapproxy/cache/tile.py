...
class TileCreator(object):
    ...
    def create_tiles(self, tiles):
        self._create_single_tile(tiles[0])
    ...
    def _query_sources(self, query):
        ...
        self.sources[0].get_map(query).as_image().save("/Users/palszabo/cors-bypass/mapproxy/single_tile_pre.png")
class Tile(object):
    """
